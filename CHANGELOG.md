...
- **Bandeau de vue par section** dans Ombres portées : sur la section
  Contacts d'un mur de cartes, deux boutons basculent d'un coup toutes les
  cartes visibles sur Fiche ou Incarner.
