...
const EditionSR5 = {
  ...
  specialSkills: {
    Lieutenant: [],
    Decker: [
      { name: "Piratage", bonus: 3 },
      { name: "Électronique", bonus: 2 },
      { name: "Cybercom.", bonus: 2 },
    ],
    Adepte: [
      { name: "Voie de l'adepte", bonus: 2 },
      { name: "Athlétisme (adepte)", bonus: 2 },
    ],
    "Mage hermétique": [
      { name: "Magie", bonus: 3 },
      { name: "Lancer de sorts", bonus: 3 },
      { name: "Invocation", bonus: 2 },
      { name: "Résistance au Drain", bonus: 2 },
    ],
    Chaman: [
      { name: "Magie", bonus: 3 },
      { name: "Lancer de sorts", bonus: 2 },
      { name: "Invocation", bonus: 3 },
      { name: "Résistance au Drain", bonus: 2 },
    ],
  },
  ...
  augsBySpecial: {
    Lieutenant: (prof) =>
      prof >= 3 ? ["Réflexes câblés 1", "Commlink intégré"] : [],
    Decker: (prof) => [
      "Accélérateur de traitement",
      "Commlink intégré (Hermes Ikon)",
      "Cyberdeck",
    ],
  ...
  generate(opts) {
    ...
    const spells = this.spellsBySpecial[special]
      ? Utils.rand(
          this.spellsBySpecial[special].slice(0, 3 + Math.floor(prof / 2)),
