...
const EditionSR5 = {
  ...
  equipPools: {
    ...
    pistoletsPoche: [
      ...
      "Fichetti Tiffani Self-Defender 2075 (Run & Gun) [PRE 4, VD 6P, PA —, CC, 4(c)]",
      "Revolver Colt New Model (Run & Gun) [PRE 6, VD 4P, PA —, SA, 5(b)]",
    ],
    pistoletsLegers: [
      ...
      "Colt Agent Special (Run & Gun) [PRE 5, VD 8P, PA —, SA, 8(c)]",
      "Fichetti Executive Action (Run & Gun) [PRE 6, VD 7P, PA —, SA, 18(c)]",
      "Nitama Sporter (Run & Gun) [PRE 6(7), VD 6P, PA —, SA, 5(c)]",
      "Shiawase Arms Puzzler (Run & Gun) [PRE 4, VD 6P, PA —, SA, 12(c)]",
    ],
    pistoletsLourds: [
      ...
      "Cavalier Deputy (Run & Gun) [PRE 6, VD 7P, PA -1, SA, 7(b)]",
      "Colt Future Frontier (Run & Gun) [PRE 6, VD 8P, PA -1, CC, 7(b)]",
      "Cavalier Deputy (Run & Gun) [PRE 6, VD 7P, PA -1, SA, 7 (b)]",
      "Colt Future Frontier (Run & Gun) [PRE 5, VD 8P, PA -1, CC, 7 (b)]",
      "Onotari Arms Violator (Run & Gun) [PRE 5 (7), VD 7P, PA -1, SA, 10 (c)]",
      "Pistolet Lourd Pliant PSK-3 (Run & Gun) [PRE 4, VD 8P, PA -1, SA, 10 (c)]",
      "Pistolet Lourd Pliant PSK-3 v2 (Run & Gun) [PRE 5 (7), VD 7P, PA -1, SA, 10 (c)]",
      "Savalette Guardian (Run & Gun) [PRE 5 (7), VD 8P, PA -1, SA, 12 (c)]",
    ],
    mitraillettes: [
      ...
      "Cavalier Evanator (Run & Gun) [PRE 5 (6), VD 6P, PA —, TR/TA, 20 (c)]",
      "Fianchetti Military 100 (Run & Gun) [PRE 5 (7), VD 6P, PA —, SA/TR/TA, 20 (c)]",
      "Onotari Arms Equalizer (Run & Gun) [PRE 4 (5), VD 7P, PA —, TR/TA, 12 (c)]",
      "Pistolet Mitrailleur Pliant PPSK-4 (Run & Gun) [PRE 5 (6), VD 6P, PA —, SA/TR, 30 (c)]",
      "Remington Suppressor (Run & Gun) [PRE 6, VD 7P, PA -1, SA/TR, 15 (c)]",
      "Ares Executioner (Run & Gun) [PRE 4 (6), VD 7P, PA —, SA/TR/TA, 30 (c)]",
      "Ultimax 70 (Run & Gun) [PRE 5 (6), VD 6P, PA —, TR/TA, 15 (c)]",
      "Ares Sigma-3 (Run & Gun) [PRE 4 (6), VD 8P, PA —, SA/TR/TA, 50 (t)]",
      "Cavalier Arms Gladius (Run & Gun) [PRE 3 (4), VD 7P, PA —, TR/TA, 32 (c)]",
      "HK Urban Combat (Run & Gun) [PRE 7 (9), VD 8P, PA —, SA/TR/TA, 36 (c)]",
      "Krime Spree (Run & Gun) [PRE 4, VD 7P, PA —, TA, 30 (c)]",
    ],
    fusilsAssaut: [
      ...
      "AK-98 (Run & Gun) [PRE 5 (7), VD 10P, PA -2, SA/TR/TA, 38 (c)]",
      "Ares HVAR (Run & Gun) [PRE 5 (7), VD 8P, PA —, SA/TR/TA, 50 (c)]",
      "Colt Inception (Run & Gun) [PRE 7 (8), VD 10P, PA -1, SA/TR, 35 (c)]",
      "HK XM30 - Carabine (Run & Gun) [PRE 6 (8), VD 9P, PA -2, SA/TR/TA, 30 (c)]",
      "HK XM30 - Fusil (Run & Gun) [PRE 5 (7), VD 8P, PA -2, SA/TR/TA, 30 (c)]",
      "HK XM30 - Mitrailleuse légère (Run & Gun) [PRE 6 (8), VD 9P, PA -2, TR/TA, 30 (c)]",
      "HK XM30 - Shotgun (Run & Gun) [PRE 3 (5), VD 10P, PA -1, SA, 10 (c)]",
      "HK XM30 - Lance-grenades (Run & Gun) [PRE 4, VD *, PA —, CC, 6 (m)]",
      "Krupp Arms Kriegfaust (Run & Gun) [PRE 8, VD 9P, PA -1, SA/TR, 25 (t)]",
      "Nitama Optimum II (Run & Gun) [PRE 5 (7), VD 9P, PA -2, SA/TR/TA, 30 (c)]",
      "Nitama Optimum II - Shotgun (Run & Gun) [PRE 4 (6), VD 10P, PA -1, SA, 5 (m)]",
      "Carabine Ultimax Rain Forest (Run & Gun) [PRE 7, VD 14P, PA -4, SA, 18 (c)]",
      "SBD-44 (Run & Gun) [PRE 3, VD 10P, PA -1, SA/TR/TA, 32 (c)]",
      "Shiawase Arms Monsoon (Run & Gun) [PRE 5 (7), VD 10P, PA -1, SA/TA, 20 (cn)×6]",
    ],
    ...
    shotguns: [
      ...
      "Auto-Assault 16 (Run & Gun) [PRE 4, VD 13P, PA -1, SA/TR/TA, 10 (c) ou 32 (t)]",
      "Cavalier Falchion (Run & Gun) [PRE 5 (7), VD 12P, PA -1, SA/TR, 8 (m)]",
      "Franchi SPAS-24 (Run & Gun) [PRE 4 (6), VD 12P, PA -1, SA/TR, 10 (c)]",
      "Krime Boss (Run & Gun) [PRE 3, VD 13P, PA -1, SA, 15 (t)]",
      "Mossberg AM-CMDT (Run & Gun) [PRE 5 (7), VD 12P, PA -1, SA/TR/TA, 10 (c)]",
      "Remington 990 (Run & Gun) [PRE 4, VD 11P, PA -1, SA, 8 (c)]",
      "Shiawase Arms Rain (Run & Gun) [PRE 4, VD 10P, PA -1, SA, 5 (cn)]",
      "Winchester Model 201 (Run & Gun) [PRE 8, VD 11P, PA -1, SA, 2 (cb)]",
      "Winchester Model 2054 (Run & Gun) [PRE 4 (5), VD 11P, PA -1, SA, 7 (m)]",
      "Winchester Model 2066 (Run & Gun) [PRE 8, VD 11P, PA -1, CC, 5 (m)]",
    ],
    ...
    mitrailleuses: [
      ...
      "GE Vindicator Minigun (Run & Gun) [PRE 4 (6), VD 9P, PA -4, TA, 100 ou 200 (bande)]",
      "Krime Wave (Run & Gun) [PRE 5, VD 10P, PA -2, TA, 50 (c) ou 100 (bande)]",
      "SA Nemesis (Run & Gun) [PRE 5 (7), VD 9P, PA -2, TR/TA, 50 (c) ou 100 (bande)]",
      "FN MAG-5 (Run & Gun) [PRE 4 (5), VD 11P, PA -3, TA, 50 (c) ou 100 (bande)]",
      "Ultimax MMG (Run & Gun) [PRE 5 (6), VD 10P, PA -2, TR/TA, 50 (c) ou 100 (bande)]",
      "Ruhrmetall SF-20 (Run & Gun) [PRE 5 (6), VD 12P, PA -4, TA, 50 (c) ou 100 (bande)]",
      "Ultimax HMG-2 (Run & Gun) [PRE 4 (5), VD 11P, PA -4, TA, 50 (c) ou 100 (bande)]",
    ],
    snipers: [
      ...
      "Barret Model 122 (Run & Gun) [PRE 7 (9), VD 14P, PA -6, SA, 14 (c)]",
      "M1 Garand (Run & Gun) [PRE 5, VD 12P, PA -1, SA, 8 (c)]",
      "Marlin 3041 BL (Run & Gun) [PRE 5, VD 10P, PA -3, SA, 6 (m)]",
      "Marlin 3468SS (Run & Gun) [PRE 4, VD 13P, PA -1, CC, 4 (m)]",
      "Marlin 79S (Run & Gun) [PRE 4, VD 6P, PA —, SA, 10 (c)]",
      "Marlin X71 (Run & Gun) [PRE 5, VD 12P, PA -4, CC, 5 (m)]",
      "Onotari Arms JP-K50 (Run & Gun) [PRE 7, VD 12P, PA -3, SA/TR, 25 (c)]",
      "Pioneer 60 (Run & Gun) [PRE 5, VD 9P, PA —, SA, 10 (c)]",
      "Springfield 2003 (Run & Gun) [PRE 9, VD 12P, PA -2, CC, 5 (m)]",
      "Springfield M1A (Run & Gun) [PRE 6, VD 12P, PA -1, SA, 20 (c)]",
      "Springfield Reproduction du Model 1855 (Run & Gun) [PRE 2, VD 10P, PA —, CC, 1 (ca)]",
      "Terracotta Arms AM-47 (Run & Gun) [PRE 7 (9), VD 15P, PA -4, SA, 18 (c)]",
      "Winchester Model 2024 (Run & Gun) [PRE 6, VD 12P, PA —, SA, 7 (m)]",
      "Winchester Model 2067 (Run & Gun) [PRE 5, VD 8P, PA -1, SA, 15 (m)]",
    ],
    ...
    armesSpeciales: [
      ...
      "Canon d'Assaut Ares Vigorous (Run & Gun) [PRE 4, VD 16P, PA -4, SA, 6 (c)]",
      "Canon d'Assaut Ogre Hammer SWS (Run & Gun) [PRE 4, VD 16P, PA -6, CC, 12 (c)]",
      "Fusil Gauss Ares Thunderstruck (Run & Gun) [PRE 7 (8), VD 15P, PA -8, SA, 10 (c) + Énergie]",
      "Krime Bomb (Run & Gun) [PRE 6 (7), VD 16P, PA -6, CC, 4 (m)]",
      "Mitsubishi Yakusoku MRL (Run & Gun) [PRE 2 × 2, VD 20P, PA selon missile, SA/TR, selon missile]",
      "Onotari Arms Ballista MML (Run & Gun) [PRE CC, VD selon missile, PA selon missile, CC, 4 (m)]",
      "Ares Redline (Run & Gun) [PRE 9, VD 14P, PA -10, SA, 10 (c) ou source externe]",
      "Ares Lancer MP Laser (Run & Gun) [PRE 7, VD 7P, PA -10, SA, 2 × 10 (c) ou source externe]",
    ],
    // Armes à distance exotiques (Run & Gun, absentes du livre de base).
    armesExotiques: [
      "Bolas - Modèle Standard (Run & Gun) [PRE Phys, VD [FOR+3]E, PA +4, 6]",
      "Bolas - Monofilament (Run & Gun) [PRE Phys, VD [FOR+3]E/12P, PA +4/-8, 18P]",
      "Ares Shocknet (Bolas) (Run & Gun) [PRE Phys -2, VD 6E[e], PA —]",
      "Bracelet Pistolet (Run & Gun) [PRE 6[d], VD 7P, PA —, CC, 1(c)]",
      "Fusil Sonique Ares Screech (Run & Gun) [PRE 9, VD —, PA —, CC, —, 10[é]]",
      "Canne Pistolet Trafalgar (Run & Gun) [PRE 6, VD 7P, PA —, CC, 1(cb)]",
      "Canne Pistolet Contrefaite (Run & Gun) [PRE 5, VD 9P, PA —, CC, —]",
      "Lance-Filet - Modèle Standard (Run & Gun) [PRE 5, VD —, PA —, CC, 4(cb), 9, 750/]",
      "Lance-Filet - Modèle XL (Run & Gun) [PRE 5, VD —, PA —, CC, 2(cb), 9, 1000/]",
      "Shocknet (Run & Gun) [PRE flexible, VD 6E[e], PA -5, flexible, flexible, 10R, +]",
      "Pistolet FN-AAL Gyrojet (Run & Gun) [PRE 5, VD 10P, PA -2, SA, 10(c), 12P]",
      "Sarbacane (Run & Gun) [PRE 8, VD 1P, PA —, CC, 1(canon), 4]",
    ],
    meleeWeapons: [
      ...
      "Claymore « Highland Forge » (Run & Gun) [PRE 5, ALLONGÉ 2, VD [FOR+5]P, PA -5]",
      "Cougar Fineblade - Lame Courte (Run & Gun) [PRE 7, VD [FOR+2]P, PA -1]",
      "Cougar Fineblade - Lame Longue (Run & Gun) [PRE 7, VD [FOR+3]P, PA -1]",
      "Épée Monofilament Ares « One » (Run & Gun) [PRE 5, ALLONGÉ 1, VD [FOR+3]P, PA -3]",
      "Lame à Mémoire Victorinox (Run & Gun) [PRE 5, ALLONGÉ 1, VD [FOR+2]P, PA -2]",
      "Dague (Run & Gun) [PRE 5, VD [FOR+1]P, PA -2]",
      "Rapière Horizon-Flynn (Run & Gun) [PRE 7, ALLONGÉ 1, VD [FOR+2]P, PA -3]",
      "Bâton Étourdissant Nemesis (Run & Gun) [PRE 6, ALLONGÉ 2, VD 3[Et(e)], PA —]",
      "Fouet (Run & Gun) [PRE 6, ALLONGÉ 2, VD [FOR+1]P, PA +3, 6]",
      "Garrot Standard (Run & Gun) [PRE 5, VD [FOR+4]E, PA -6, —]",
      "Garrot Monofilament (Run & Gun) [PRE 5, VD [FOR+0]P, PA -8, 18P]",
      "Tronçonneuse de Combat (Run & Gun) [PRE 5, ALLONGÉ 1, VD 8P, PA -4]",
      "Tronçonneuse Monofilament (Run & Gun) [PRE 5, ALLONGÉ 1, VD 12P, PA -8]",
      "Tronçonneuse de Combat Ash Arms (Run & Gun) [PRE 5, ALLONGÉ 1, VD 8P, PA -4]",
      "Tronçonneuse Monofilament Ash Arms (Run & Gun) [PRE 5, ALLONGÉ 1, VD 12P, PA -8]",
      "Bouteille (entière) (Run & Gun) [PRE 3, VD [FOR+1]E, PA —]",
      "Bouteille (brisée, après 1er coup) (Run & Gun) [PRE 3, VD [FOR]P, PA —]",
      "Chaîne (version 1) (Run & Gun) [PRE 4, ALLONGÉ 2, VD [FOR+1]P, PA —]",
      "Chaîne (version 2) (Run & Gun) [PRE 3, ALLONGÉ 1, VD [FOR+2]E, PA —]",
      "Crosse de Fusil (Run & Gun) [PRE 3, VD [FOR+3]P, PA —]",
      "Fourchette (Run & Gun) [PRE 4, VD [FOR-1]P, PA +1]",
      "Poêle à Frire (Run & Gun) [PRE 3, VD [FOR+1]P, PA —]",
      "Marteau (Run & Gun) [PRE 3, ALLONGÉ 1, VD [FOR-1]P, PA -1/2²]",
      "Masse (Run & Gun) [PRE 3, ALLONGÉ 2, VD [FOR+4]P, PA —, 1]",
      "Pistolets (Run & Gun) [PRE 4, VD [FOR+1]P, PA —]",
      "Queue de Billard (Run & Gun) [PRE 4, VD [FOR]P, PA —]",
      "Arbalète de Poing Ranger Sliver (Run & Gun) [PRE 7, VD 4P, PA —, CC]",
      "Fronde Ares Giantslayer (Run & Gun) [PRE 7, VD 2P, PA —, CC]",
      "Lance-Harpon Standard (Run & Gun) [PRE 5, VD 9P, PA -2, CC, 1(m)]",
      "Lance-Harpon Aquadyne Shark-XS (Run & Gun) [PRE 5, VD 9P, PA -2, CC, —]",
      "Boomerang - Modèle Standard (Run & Gun) [PRE Phys -1, VD [FOR+2]P, PA —, 4]",
      "Boomerang - Horizon BoomEye (Run & Gun) [PRE Phys -1, VD —, PA —, 4]",
      "Filet - Modèle Standard (Run & Gun) [PRE Phys -2, VD —, PA —, 6]",
      "Filet - Terracotta Shrednet (Run & Gun) [PRE Phys -2, VD 4P, PA —]",
      "Filet - Ares Shocknet (Run & Gun) [PRE Phys -2, VD 6E[e], PA —]",
      "Harpon/Javelot (Run & Gun) [PRE Phys +1, VD [FOR+2]P, PA -1, 4]",
      "Tomahawk Urban Tribe (Run & Gun) [PRE Phys +1, VD [FOR+2]P, PA -1, 4]",
    ],
    electroarmes: [
      ...
      "Cavalier Safeguard (Run & Gun) [PRE 5(6), VD 6E(e), PA -5, SA, 6(m), —]",
      "Tiffani-Defiance Protector (Run & Gun) [PRE 5(6), VD 7E(u), PA -5, SA, 3(m), 2]",
    ],
    armures: {
      legere: [
        "Veste pare-balles [9]",
    ...
    cyberware: [
      ...
      "Antenne (Chrome Flesh) [Essence 0.1, récepteur longues distances]",
      "Augmentation du spectre auditif (Chrome Flesh) [Essence 0.1, détection infrason/ultrasonic]",
      "Lampe oculaire (Chrome Flesh) [Essence 0.1, vision à portée 2m + lumière nocturne]",
      "Lentilles microscopiques (Chrome Flesh) [Essence 0.2, vision à 50x]",
      "Monture oculaire supplémentaire (Chrome Flesh) [Essence 0.2, +2 aux tests de surprise]",
      "Protections oculaires (Chrome Flesh) [Essence 0.1, armure +3 pour yeux]",
      "Yeux d'araignée (Chrome Flesh) [Essence 0.2, détection à 10m minimum]",
      "Système d'orientation (Chrome Flesh) [Essence 0.2, bonus +2 à Orientation]",
      "USP mathématique (Chrome Flesh) [Essence 0.1, bonus +4 à compétences scientifiques]",
      "Visualiseur (Chrome Flesh) [Essence 0.1, créer image mentale en 5 secondes]",
      "Senseur radar (Chrome Flesh) [Indice 1-4, détection obstacles/mouvements]",
      "Synthlink (Chrome Flesh) [Essence 0.1, interface instruments musicaux intelligents]",
      "Autoinjectoreur (Chrome Flesh) [Essence 0.05, administration de médicaments/drogues]",
      "Articulations intelligentes (Chrome Flesh) [Essence 0.5, Limite physique +2]",
      "Biomoniteur (Chrome Flesh) [Essence 0.1, suivi données de santé constant]",
      "Ancres de pied (Chrome Flesh) [Essence 0.25, bonus +1 à équilibre/escalade]",
      "Griffe d'escalade rétractiles (Chrome Flesh) [Essence 0.2, escalade facilitée]",
      "Interface tactile (Chrome Flesh) [Essence 0.1, sens tactile +2 pour tests Perception]",
      "Main flexible (Chrome Flesh) [Essence 0.15, compression/déformation mains]",
      "Neuro-stimulateur gastrique (Chrome Flesh) [Essence 0.2, immunité nausée/poison]",
      "Palmes cybernétiques (Chrome Flesh) [Essence 0.1, vitesse nage +150%]",
      "Pointeur laser (Chrome Flesh) [Essence 0.2, Précision d'arme +1]",
      "Queue balancier (Chrome Flesh) [Essence 0.25, Équilibre bonus +1]",
      "Routeur interne (Chrome Flesh) [Essence 0.7, système sans fil intégré]",
      "Système magnétique (Chrome Flesh) [Essence 0.25, Force de 6 pour soulever métal]",
      "Système move-by-wire (Chrome Flesh) [Indice 1-3, réflexes +1 à +3 selon indice]",
      "Membres modulaires connecteurs (Chrome Flesh) [Essence 0.35-1.3, configuration flexible]",
      "Corps liminaire (Chrome Flesh) [Essence 3.0, restructuration abdominale complète]",
      "Crâne cybernétique partiel (Chrome Flesh) [Essence 0.4, remplacement os du crâne]",
      "Doigts cybernétiques (Chrome Flesh) [Essence 0.05, configuration spécialisée]",
      "Doigts serpentiformes (Chrome Flesh) [Essence variable, articulations rotatives]",
      "Glisseurs (Chrome Flesh) [Essence variable, vitesse nage x2-3]",
      "Hydrojet (Chrome Flesh) [Essence variable, vitesse nage augmentée]",
      "Jambe de digitigrade (Chrome Flesh) [Essence variable, forme animale]",
      "Kit utilitaire intégré (Chrome Flesh) [Essence 0.45, outils spécialisés embarqués]",
      "Main grappin (Chrome Flesh) [Essence 0.45, lancer projectile ou grappin]",
      "Médikit intégré (Chrome Flesh) [Essence 0.45, kit médical embarqué]",
      "Branchies cybernétiques OXSYS (Chrome Flesh) [Essence 0.25, respiration aquatique]",
      "Compétence câblée (Chrome Flesh) [Indice variable, compétence active liée Matrix]",
      "Cran de sûreté cybernétique (Chrome Flesh) [—, freinage arme intégrée]",
      "Extension de stockage des excréments (Chrome Flesh) [Indice variable, stockage journée]",
      "Chipjack (Chrome Flesh) [Essence Indice 0.05, Capacité Indice x2, accès logiciels]",
      "Connaissance câblée (Chrome Flesh) [Essence Indice 0.05, Capacité Indice x4, savoir embarqué]",
      "Coprocesseur attentionnel (Chrome Flesh) [Essence 0.3, Limite mentale +1 à Perception]",
      "Enregistreur onrique (Chrome Flesh) [Essence 0.1, enregistrement rêves]",
      "Faux visage (Chrome Flesh) [Essence 0.5, apparence humanoïde modifiable]",
      "Camouflage vocal (Chrome Flesh) [Essence 0.1, voix modifiable +8P]",
      "Réduction de métaype (Chrome Flesh) [Essence 0.2, apparence humaine sans payer Karma]",
      "Tatouages LED (Chrome Flesh) [Essence petit/moyen/grand, affichage LEDs sous peau]",
      "Modification d'enveloppe (Chrome Flesh) [Essence variable, cybernétique personnalisée]",
      "Organes génitaux cybernétiques (Chrome Flesh) [Essence 0.25, configuration modulaire]",
    ],
    bioware: [
      ...
      "Modification d'enveloppe (Chrome Flesh) [—, chirurgie mineure/modérée/importante]",
      "Modification ethnique/changement de sexe (Chrome Flesh) [Essence —, restructuration faciale]",
      "Augmentation mammaire (Chrome Flesh) [Essence —, modification taille implants]",
      "Oreilles pointues (Chrome Flesh) [Essence —, modification esthétique]",
      "Peau de caméléon (Chrome Flesh) [Essence —, camouflage thermique/colorimétrique]",
      "Peau soyeuse (Chrome Flesh) [Essence —, aspect esthétique]",
      "Pigmentation dermique (Chrome Flesh) [Essence —, tatouages biologiques]",
      "Nouveaux cheveux (Chrome Flesh) [Essence —, croissance naturelle]",
      "Rucoloation des yeux (Chrome Flesh) [Essence —, coloration oculaire]",
      "Réduction du poids (Chrome Flesh) [Essence —, allègement corporel]",
      "Régimeware (Chrome Flesh) [Essence 0.1, métabolisme accéléré]",
      "Réduction de troll (Chrome Flesh) [Essence 0.2-0.5, réduction physique troll]",
      "Peau à chloroplastes (Chrome Flesh) [Essence 0.2, bonus +2 aux tests Survie]",
      "Peau sensible (Chrome Flesh) [Essence —, augmentation sensibilité tactile]",
      "Croissance capillaire (Chrome Flesh) [Essence —, croissance rapide cheveux]",
      "Métabolisme propre (Chrome Flesh) [Essence 0.1, système digestif optimisé]",
      "Amélioration de l'ouïe (Chrome Flesh) [Essence 0.1, +1 test Perception auditive]",
      "Articulations élastiques (Chrome Flesh) [Essence 0.2, Limite physique +1 en glisr espaces]",
      "Augmentation de spectre vocal (Chrome Flesh) [Essence 0.1-0.2, sons supplémentaires]",
      "Expansion du spectre auditif (Chrome Flesh) [Essence 0.1, détection 5-20kHz/200kHz]",
      "Bouclier rénal (Chrome Flesh) [Essence Indice, résistance drogues/poisons]",
      "Glande à soies d'araignée (Chrome Flesh) [Essence 0.3, soies projectiles]",
      "Glande chimique (Chrome Flesh) [Essence 0.1, production substances chimiques]",
      "Membrane nictitante (Chrome Flesh) [Essence 0.05, protection oculaire anti-flash]",
      "Phéromones de créatures optimisées (Chrome Flesh) [Essence Indice 1-3, influence animale]",
      "Réalignement spinal (Chrome Flesh) [Essence 0.1, traitement colonne vertébrale]",
      "Remplacement d'un membre (Chrome Flesh) [Essence 0.1-0.4, bras/jambe/main]",
      "Replacement d'articulations (Chrome Flesh) [Essence 0.05, restructuration osseuse]",
      "Sensibilité tactile (Chrome Flesh) [Essence 0.1, +2 tests Perception tactile]",
      "Système immunitaire amplifié (Chrome Flesh) [Essence Indice, résistance maladies]",
      "Volume respiratoire étendu (Chrome Flesh) [Essence Indice 1-4, résistance fatigue]",
      "Yeux de trolls (Chrome Flesh) [Essence 0.2, vision thermique]",
      "Croissance capillaire (Chrome Flesh) [Essence —, surface equivalent tête humaine]",
      "Accroissement de la neuro-rétention (Chrome Flesh) [Essence 0.1, mémoire photographique gratuite]",
      "Accroissement de traitement sensoriel (Chrome Flesh) [Essence 0.2, traitement données sensorielles]",
      "Cervelet amplifié (Chrome Flesh) [Essence —, amplification coordination]",
      "Réaction (Chrome Flesh) [hormone transgenique de stress]",
      "Qualia (Chrome Flesh) [hormone reptilienne - stimule cortex sensoriel]",
      "Pushed (Chrome Flesh) [protéine HyperDensité - augmente cellules]",
      "Pneumacité squelettique (Chrome Flesh) [résistance osseuse]",
      "Synch (Chrome Flesh) [protéine nootropique - perception/intuition]",
      "Vasocon (Chrome Flesh) [régule flux sanguin]",
      "Vision tétrachromatique (Chrome Flesh) [vision métamaine type cône]",
      "Adaptation à la chaleur (Chrome Flesh) [résiste dommages froid]",
      "Adaptation à la microgravité (Chrome Flesh) [résiste dégâts chutes/microgravité]",
      "Adaptation au froid (Chrome Flesh) [résiste dommages froid extrême]",
      "Cryotolélrance (Chrome Flesh) [ensemble modifications génétiques - résistance froid]",
      "Tolérance à la pollution (Chrome Flesh) [réduit dommages toxines chimiques]",
      "Tolérance aux radiations (Chrome Flesh) [réduit dommages radiations]",
      "Tolérance à l'hypoxie (Chrome Flesh) [retient souffle prolongé]",
      "Tolérance aux allergènes (Chrome Flesh) [réduit allergies]",
      "Immunisation (Chrome Flesh) [immunité complète une maladie/toxine]",
      "Altération transgenique (Chrome Flesh) [modifie phénotype]",
      "Optimisation d'accroissement de réaction (Chrome Flesh) [+1 Initiative]",
      "Optimisation de fixateur de réflexes (Chrome Flesh) [pas modifiateur supplémentaire]",
      "Optimisation de la pompe à adrénaline (Chrome Flesh) [retarde cortisol]",
      "Optimisation des réflexes câblés (Chrome Flesh) [réduit vitesse déclenchement]",
      "Optimisation du câblage de contrôle de véhicules (Chrome Flesh) [+1 Pilotage]",
      "Symbiose améliorée (Chrome Flesh) [améliore fonctionnement pancréas]",
      "Infusions génétiques (Chrome Flesh) [traitement génétique]",
      "Restauration génétique (Chrome Flesh) [guérison essence de l'expérience de vie]",
      "Extension de l'espérance de vie (Chrome Flesh) [augmente longévité]",
      "Guérison augmentée (Chrome Flesh) [plus rapide de 25%]",
      "Réparation cellulaire (Chrome Flesh) [traitement régénérant]",
      "Revitalisation (Chrome Flesh) [vitesse réaction essence]",
      "Vigeur physique (Chrome Flesh) [détection origine magnétique]",
    ],
    // Nanotechnologie (Chrome Flesh, absente du livre de base).
    nanotechnologie: [
      "Amplificateur d'interface de rigging (Chrome Flesh) [+modifiateur pour Pilotage de véhicules/drones]",
      "Antirad (Chrome Flesh) [réduit dommages radiations]",
      "Chasseur de nanites (Chrome Flesh) [détruit nanites actives]",
      "Nanodonnées (Chrome Flesh) [transporte données sensibles]",
      "Nanomarqueurs (Chrome Flesh) [marque/identifie nanites]",
      "Nanotatouages (Chrome Flesh) [afficheur d'images cutané programmable]",
      "Soigneur d'implant (Chrome Flesh) [répare implants endommagés]",
      "Amplificateur neuraux - Stimulateur d'apprentissage (Chrome Flesh) [améliore compréhension]",
      "Amplificateur neuraux - Limbique (Chrome Flesh) [modifiateur réflexes câblés]",
      "Amplificateur neuraux - Néocortical (Chrome Flesh) [améliore pensée abstraite]",
      "Amplificateur neuraux - Rappel (Chrome Flesh) [améliore mémoire]",
      "Antitoxine (Chrome Flesh) [réduit puissance toxines]",
      "Carcérande-plus (Chrome Flesh) [transporte drogue en sphères moléculaires]",
      "Cellules-O (Chrome Flesh) [réduit indices pathogènes viraux/bactériens]",
      "Nanosymbiótes (Chrome Flesh) [colonnes nanites spécialisées]",
      "Nantidotes (Chrome Flesh) [immunité toxines]",
      "Oxyrush (Chrome Flesh) [stabilise oxygène sanguin]",
      "Nanocybernétique (Chrome Flesh) [hybride nanoware/cyberware]",
      "Imitateur vocal (Chrome Flesh) [modifie voix du sujet]",
      "Nanoruche (Chrome Flesh) [implant de coordination/control]",
      "Peau intelligente (Chrome Flesh) [polymères intelligents pour camouflage]",
      "Système flash-back (Chrome Flesh) [sauvegarde souvenirs/stimulation mémoire]",
      "Alternapeau (Chrome Flesh) [couche réactive de nanites]",
      "Graveurs (Chrome Flesh) [inscrit permanemment sur os]",
      "Médikit Savior (Chrome Flesh) [soins nanométriques]",
      "Monofilaments (Chrome Flesh) [câbles super fins]",
      "Nanoscanner (Chrome Flesh) [détecte nanoware implanté]",
      "Nanospion (Chrome Flesh) [surveillance discrète]",
      "Nanocréme de maquillage (Chrome Flesh) [déguisement cosmétique]",
      "Corrosifs intelligents (Chrome Flesh) [nanites en solution chimique]",
      "Enduit universel (Chrome Flesh) [nanites en suspension]",
    ],
    equipSpecial: [
      ...
      "Injecteur chimique portable (Chrome Flesh) [3 tailles de doses : 3 doses/500 nuyens, 5 doses/750 nuyens, 20 doses/2500 nuyens]",
      "Pharmacie quotidienne (Chrome Flesh) [contraceptifs, analgésiques, antihistaminiques]",
      "Préparation de drogues (Chrome Flesh) [accessoires de rue]",
      "Ensemble de drogues customisées (Chrome Flesh) [à faible, modéré ou haut coût]",
    ],
  },
