...
const EditionAnarchy = {
  ...
  formOptions: {
    ...
    profession: [
      'Aléatoire',
      'Ganger', 'Ganger d\'élite', 'Ganger éveillé', 'Ganger adepte', 'Ganger decker',
      'Agent de sécurité', 'Officier de sécurité', 'Officier d\'élite',
      'Mage de sécurité', 'Mage d\'élite', 'Adepte de sécurité', 'Adepte d\'élite',
      'Decker de sécurité', 'Decker d\'élite',
      'Militaire', 'Commando militaire',
      'Johnson', 'Employé corporatiste', 'Enquêteur',
    ],
  },
  ...
  profils: {
    ...
    'Ganger': {
      ...
      skills: [
        { name:'Athlétisme',      val:3, attr:'FOR', rr:0, specMeta:{ Troll:{val:4} } },
        { name:'Déf. à distance', val:3, attr:'AGI', rr:0, spec:true },
        { name:'Armes à distance',val:3, attr:'AGI', rr:0 },
        { name:'Combat rapproché',val:3, attr:'AGI', rr:0, spec:'Lames', specVal:4, specRR:0 },
        { name:'Furtivité',       val:3, attr:'AGI', rr:0 },
        { name:'Perception',      val:3, attr:'LOG', rr:0 },
        { name:'Influence',       val:2, attr:'CHA', rr:0, spec:'Intimidation', specVal:3, specRR:0 },
      ],
      atouts: [],
      atoutsChoix: 1,
      atoutsOptions: [
      ...
      armes: [
        { name:'Mains nues',    vd:'3 (orks 4, trolls 5)', portees:'[OK/–/–/–]' },
      ...
      combativite: 'faible',
      seuilsPhys: [4,7,10],
      seuilsPhysMeta: { Ork:[5,8,11], Troll:[6,9,12], Nain:null, Elfe:null },
      seuils_ment: [2,5,8],
    ...
    'Ganger d\'élite': {
      ...
      attrsMeta: { Ork:{ FOR:4 }, Troll:{ FOR:5 }, Nain:{}, Elfe:{ AGI:3 } },
      skills: [
        { name:'Athlétisme',      val:3, attr:'FOR', rr:0, specMeta:{ Troll:{val:4} } },
        { name:'Déf. à distance', val:4, attr:'AGI', rr:0, spec:true },
        { name:'Armes à distance',val:3, attr:'AGI', rr:0, spec:'Mitraillettes', specVal:4, specRR:0 },
        { name:'Combat rapproché',val:4, attr:'AGI', rr:0, spec:'Lames', specVal:4, specRR:0 },
        { name:'Furtivité',       val:3, attr:'AGI', rr:0 },
        { name:'Perception',      val:3, attr:'LOG', rr:0 },
        { name:'Influence',       val:3, attr:'CHA', rr:0, spec:'Intimidation', specVal:3, specRR:0 },
      ],
      atouts: [],
      atoutsChoix: 2,
      atoutsOptions: [
      ...
      armes: [
        { name:'Mains nues',     vd:'3 (orks 4, trolls 5)', portees:'[OK/–/–/–]' },
        { name:'Arme longue',    vd:'5 (orks 6, trolls 7)', portees:'[OK/–/–/–]' },
    ...
    'Ganger éveillé': {
      ...
      attrsMeta: { Ork:{ FOR:3 }, Troll:{ FOR:4 }, Nain:{ VOL:4 }, Elfe:{ VOL:3 } },
      skills: [
        { name:'Athlétisme',    val:2, attr:'FOR', rr:0, specMeta:{ Ork:{val:3}, Troll:{val:3} } },
        { name:'Déf. à distance',val:3,attr:'AGI', rr:0, spec:true },
        { name:'Combat rapproché',val:3,attr:'AGI', rr:0 },
        { name:'Furtivité',     val:3, attr:'AGI', rr:0 },
        { name:'Perception',    val:3, attr:'LOG', rr:0 },
        { name:'Sorcellerie',   val:3, attr:'VOL', rr:0, spec:'Sorts de combat', specVal:4, specRR:0 },
        { name:'Conjuration',   val:3, attr:'LOG', rr:0, spec:'Esprits du feu',  specVal:4, specRR:0 },
        { name:'Influence',     val:2, attr:'CHA', rr:0 },
        { name:'Intimidation',  val:3, attr:'CHA', rr:0 },
      ],
      atouts: ['Éveillé (tradition au choix) : Perception & projection astrale, Sorcellerie, Conjuration'],
      atoutsChoix: 1,
      atoutsOptions: [
      ...
      armes: [
        { name:'Mains nues', vd:'2 (orks 3, trolls 4)', portees:'[OK/–/–/–]' },
    ...
    'Ganger adepte': {
      ...
      skills: [
        { name:'Athlétisme',      val:3, attr:'FOR', rr:0, specMeta:{ Ork:{val:4}, Troll:{val:4} } },
        { name:'Déf. à distance', val:4, attr:'AGI', rr:0, spec:true },
        { name:'Combat rapproché',val:4, attr:'AGI', rr:0, spec:'Mains nues', specVal:4, specRR:0 },
        { name:'Furtivité',       val:3, attr:'AGI', rr:0, spec:'Discrétion physique', specVal:3, specRR:0 },
        { name:'Perception',      val:3, attr:'LOG', rr:0 },
        { name:'Influence',       val:2, attr:'CHA', rr:0 },
        { name:'Intimidation',    val:3, attr:'CHA', rr:0 },
      ],
    ...
    'Ganger decker': {
      ...
      attrsMeta: { Ork:{ FOR:3 }, Troll:{ FOR:4 }, Nain:{ LOG:4 }, Elfe:{} },
      skills: [
        { name:'Athlétisme',       val:2, attr:'FOR', rr:0, specMeta:{ Ork:{val:3}, Troll:{val:3} } },
        ...
        { name:'Furtivité',        val:3, attr:'AGI', rr:0 },
        { name:'Perception',       val:3, attr:'LOG', rr:0 },
        { name:'Électronique',     val:3, attr:'LOG', rr:0, spec:'Recherche matricielle', specVal:3, specRR:0 },
        { name:'Piratage',         val:3, attr:'LOG', rr:0, spec:'Force brute', specVal:4, specRR:0 },
        { name:'Cybercombat',      val:3, attr:'VOL', rr:0 },
      ],
      atouts: ['Cyberdeck (Attaque 1, Firewall 2)', 'Datajack (cyberware) : IND, RV cold-sim'],
      atoutsChoix: 1,
      atoutsOptions: [
    ...
    'Agent de sécurité': {
      ...
      skills: [
        { name:'Athlétisme',      val:3, attr:'FOR', rr:0, specMeta:{ Troll:{val:4} } },
        { name:'Déf. à distance', val:3, attr:'AGI', rr:0, spec:true },
        { name:'Armes à distance',val:3, attr:'AGI', rr:0, spec:'Pistolets', specVal:3, specRR:0 },
        { name:'Combat rapproché',val:3, attr:'AGI', rr:0 },
        { name:'Furtivité',       val:2, attr:'AGI', rr:0 },
        { name:'Perception',      val:3, attr:'LOG', rr:0, spec:'Physique', specVal:4, specRR:0 },
      ...
      armes: [
        { name:'Mains nues',       vd:'3 (orks 4, trolls 5)', portees:'[OK/–/–/–]' },
        { name:'Électromatraque',  vd:'5',                    portees:'[OK/–/–/–], perte action' },
        { name:'Pistolet léger',   vd:'4',                    portees:'[OK/OK/Dés./–]' },
      ],
    ...
    'Officier de sécurité': {
      ...
      skills: [
        ...
        { name:'Déf. à distance', val:4, attr:'AGI', rr:0, spec:true },
        { name:'Armes à distance',val:5, attr:'AGI', rr:1, spec:'Mitraillettes/Shotguns', specVal:5, specRR:1 },
        { name:'Combat rapproché',val:4, attr:'AGI', rr:0, spec:'Armes contondantes', specVal:4, specRR:0 },
        { name:'Furtivité',       val:3, attr:'AGI', rr:0 },
        { name:'Perception',      val:3, attr:'LOG', rr:0, spec:'Physique', specVal:4, specRR:1 },
        { name:'Influence',       val:3, attr:'CHA', rr:0 },
      ],
      atouts: ['Yeux cybernétiques avec identification de cibles : RR 1 Armes à distance et Perception (physique), vision nocturne'],
      atoutsChoix: 1,
      atoutsOptions: [
      ...
      armes: [
        ...
        { name:'Électromatraque', vd:'5',                    portees:'[OK/–/–/–], perte action' },
        { name:'Pistolet lourd',  vd:'5',                    portees:'[OK/OK/Dés./–]' },
        { name:'Mitraillette OU Shotgun', vd:'5 / 8',        portees:'[Dés./OK/OK/–] / [Dés./OK/Dés./–]' },
      ],
      equip: ['Commlink', 'Gilet pare-balles (Armure 3)', 'Bouclier anti-émeutes optionnel (Armure +1)'],
      combativite: 'faible',
      seuilsPhys: [6,9,12],
      seuilsPhysMeta: { Ork:[7,10,13], Troll:[8,11,14] },
      seuils_ment: [2,5,8],
    ...
    'Officier d\'élite': {
      ...
      attrsMeta: { Ork:{ FOR:4 }, Troll:{ FOR:5 }, Nain:{ AGI:4 }, Elfe:{} },
      skills: [
        { name:'Athlétisme',       val:4, attr:'FOR', rr:0, specMeta:{ Troll:{val:5} } },
        { name:'Déf. à distance',  val:5, attr:'AGI', rr:0, spec:true },
        { name:'Armes à distance', val:5, attr:'AGI', rr:1, spec:'Arme principale', specVal:8, specRR:3 },
        { name:'Combat rapproché', val:5, attr:'AGI', rr:1, spec:'Armes contondantes', specVal:6, specRR:1 },
        { name:'Furtivité',        val:4, attr:'AGI', rr:0, spec:'Discrétion physique', specVal:5, specRR:0 },
        { name:'Perception',       val:4, attr:'LOG', rr:0, spec:'Physique', specVal:5, specRR:1 },
        { name:'Influence',        val:3, attr:'CHA', rr:0 },
      ],
      atouts: [
      ...
      armes: [
        ...
        { name:'Électromatraque', vd:'5',                    portees:'[OK/–/–/–], perte action' },
        { name:'Pistolet lourd',  vd:'5',                    portees:'[OK/OK/Dés./–]' },
        { name:'Shotgun / Fusil d\'assaut / Sniper / Mitrailleuse', vd:'8 / 7 / 10 / 9', portees:'au choix' },
      ],
      equip: ['Commlink', 'Armure intégrale + Casque (Armure 4)', 'Bouclier balistique optionnel (Armure +1)'],
      combativite: 'forte',
      seuilsPhys: [7,10,13],
    ...
    'Mage de sécurité': {
      ...
      attrsMeta: { Ork:{ FOR:3 }, Troll:{ FOR:4 }, Nain:{ VOL:4 }, Elfe:{} },
      skills: [
        { name:'Athlétisme',      val:3, attr:'FOR', rr:0, specMeta:{ Troll:{val:4} } },
        { name:'Déf. à distance', val:4, attr:'AGI', rr:0, spec:true },
        { name:'Armes à distance',val:3, attr:'AGI', rr:0 },
        { name:'Combat rapproché',val:3, attr:'AGI', rr:0 },
        { name:'Furtivité',       val:3, attr:'AGI', rr:0 },
        { name:'Perception',      val:4, attr:'LOG', rr:0, spec:'Astrale', specVal:4, specRR:0 },
        { name:'Sorcellerie',     val:4, attr:'VOL', rr:0, spec:'Sorts de combat', specVal:4, specRR:0 },
        { name:'Conjuration',     val:4, attr:'LOG', rr:0, spec:'Esprits des aînés', specVal:4, specRR:0 },
        { name:'Influence',       val:3, attr:'CHA', rr:0 },
      ],
      atouts: [
      ...
      seuilsMat: null,
      eveille: 'hermétique',
      sorts: ['Analyse de véracité','Armure','Confusion','Détection des ennemis','Éclair étourdissant','Foudre','Sens du combat','Soins'],
    },

    'Mage d\'élite': {
      label: 'Mage d\'élite de sécurité / Police',
      attrs: { FOR:2, AGI:3, VOL:4, LOG:3, CHA:2 },
      attrsMeta: { Ork:{ FOR:3 }, Troll:{ FOR:4 }, Nain:{ VOL:5 }, Elfe:{} },
      skills: [
        { name:'Athlétisme',      val:3, attr:'FOR', rr:0, specMeta:{ Ork:{val:4}, Troll:{val:4} } },
        { name:'Déf. à distance', val:4, attr:'AGI', rr:0, spec:true },
        ...
        { name:'Perception',      val:4, attr:'LOG', rr:0, spec:'Astrale', specVal:5, specRR:0 },
        { name:'Sorcellerie',     val:5, attr:'VOL', rr:1, spec:'Sorts de combat', specVal:8, specRR:3 },
        { name:'Conjuration',     val:4, attr:'LOG', rr:0, spec:'Esprits des aînés', specVal:5, specRR:0 },
        { name:'Influence',       val:3, attr:'CHA', rr:0 },
      ],
      atouts: [
        'Éveillé (tradition hermétique) : Perception & projection astrale, Sorcellerie, Conjuration',
      ...
      seuilsMat: null,
      eveille: 'hermétique',
      sorts: ['Armure','Augmentation de réflexes','Barrière physique','Confusion','Détection des ennemis','Éclair étourdissant','Foudre','Invisibilité','Sens du combat','Soins'],
    },
    ...
    'Adepte de sécurité': {
      ...
      skills: [
        ...
        { name:'Déf. à distance', val:4, attr:'AGI', rr:0, spec:true },
        { name:'Armes à distance',val:4, attr:'AGI', rr:0 },
        { name:'Combat rapproché',val:4, attr:'AGI', rr:0, spec:'Mains nues', specVal:5, specRR:1 },
        { name:'Furtivité',       val:3, attr:'AGI', rr:0, spec:'Discrétion physique', specVal:4, specRR:0 },
        { name:'Perception',      val:3, attr:'LOG', rr:0 },
        { name:'Influence',       val:3, attr:'CHA', rr:0 },
      ],
      atouts: [
    ...
    'Adepte d\'élite': {
      ...
      skills: [
        { name:'Athlétisme',      val:4, attr:'FOR', rr:0, specMeta:{ Ork:{val:5}, Troll:{val:5} } },
        { name:'Déf. à distance', val:6, attr:'AGI', rr:1, spec:true },
        { name:'Armes à distance',val:4, attr:'AGI', rr:0 },
        { name:'Combat rapproché',val:4, attr:'AGI', rr:0, spec:'Mains nues', specVal:8, specRR:3 },
        { name:'Furtivité',       val:4, attr:'AGI', rr:0, spec:'Discrétion physique', specVal:5, specRR:0 },
      ...
      armes: [
        { name:'Mains nues',     vd:'4 (orks 5, trolls 6)', portees:'[OK/–/–/–]' },
        { name:'Pistolet lourd', vd:'5',                    portees:'[OK/OK/Dés./–]' },
      ],
      equip: ['Commlink', 'Armure intégrale + Casque (Armure 4)'],
      combativite: 'forte',
    ...
    'Decker de sécurité': {
      ...
      skills: [
        ...
        { name:'Combat rapproché',  val:2, attr:'AGI', rr:0 },
        { name:'Furtivité',         val:3, attr:'AGI', rr:0, spec:'Discrétion physique', specVal:4, specRR:0 },
        { name:'Perception',        val:3, attr:'LOG', rr:0, spec:'Matricielle', specVal:4, specRR:0 },
        { name:'Électronique',      val:4, attr:'LOG', rr:0, spec:'Protection matricielle', specVal:4, specRR:0 },
        { name:'Piratage',          val:4, attr:'LOG', rr:0, spec:'Cybercombat', specVal:4, specRR:0 },
      ],
      atouts: [
    ...
    'Decker d\'élite': {
      ...
      skills: [
        ...
        { name:'Combat rapproché', val:3, attr:'AGI', rr:0 },
        { name:'Furtivité',        val:4, attr:'AGI', rr:0, spec:'Discrétion physique', specVal:5, specRR:0 },
        { name:'Perception',       val:4, attr:'LOG', rr:0, spec:'Matricielle', specVal:5, specRR:0 },
        { name:'Électronique',     val:5, attr:'LOG', rr:1, spec:'Protection matricielle', specVal:6, specRR:1 },
        { name:'Piratage',         val:5, attr:'LOG', rr:1, spec:'Cybercombat', specVal:6, specRR:1 },
      ],
      atouts: [
      ...
      armes: [
        ...
        { name:'Électromatraque', vd:'5',                    portees:'[OK/–/–/–], perte action' },
        { name:'Pistolet lourd',  vd:'5',                    portees:'[OK/OK/Dés./–]' },
        { name:'Cybercombat',     vd:'5 (+ marteau : 7)',    portees:'[matriciel]' },
      ],
      equip: ['Commlink', 'Armure intégrale + Casque (Armure 4)'],
      combativite: 'forte',
      seuilsPhys: [6,9,12],
    ...
    'Militaire': {
      ...
      attrsMeta: { Ork:{ FOR:4 }, Troll:{ FOR:5 }, Nain:{ VOL:4 }, Elfe:{} },
      skills: [
        { name:'Athlétisme',      val:4, attr:'FOR', rr:0 },
        { name:'Déf. à distance', val:5, attr:'AGI', rr:1, spec:true },
        { name:'Armes à distance',val:5, attr:'AGI', rr:1, spec:'Arme principale', specVal:6, specRR:2 },
        { name:'Combat rapproché',val:4, attr:'AGI', rr:0, spec:'Lames', specVal:5, specRR:1 },
        { name:'Furtivité',       val:3, attr:'AGI', rr:0 },
        { name:'Perception',      val:3, attr:'LOG', rr:0, spec:'Physique', specVal:4, specRR:1 },
      ...
      armes: [
        { name:'Mains nues',        vd:'3 (orks 4, trolls 5)', portees:'[OK/–/–/–]' },
        { name:'Couteau de combat', vd:'4 (orks 5, trolls 6)', portees:'[OK/–/–/–]' },
        { name:'Pistolet lourd',    vd:'5',                    portees:'[OK/OK/Dés./–]' },
        { name:'Grenades',          vd:'7',                    portees:'[OK/OK/Dés./–]' },
        { name:'Fusil d\'assaut / Shotgun / Mitrailleuse', vd:'7 / 8 / 9', portees:'au choix' },
      ],
    ...
    'Commando militaire': {
      ...
      skills: [
        { name:'Athlétisme',      val:4, attr:'FOR', rr:0, specMeta:{ Ork:{val:5}, Troll:{val:5} } },
        { name:'Déf. à distance', val:6, attr:'AGI', rr:1, spec:true },
        { name:'Armes à distance',val:6, attr:'AGI', rr:1, spec:'Fusils', specVal:8, specRR:3 },
        { name:'Combat rapproché',val:4, attr:'AGI', rr:0, spec:'Lames', specVal:7, specRR:2 },
        { name:'Furtivité',       val:4, attr:'AGI', rr:0, spec:'Discrétion physique', specVal:5, specRR:0 },
        { name:'Perception',      val:3, attr:'LOG', rr:0, spec:'Physique', specVal:5, specRR:1 },
      ...
      armes: [
        { name:'Mains nues',        vd:'4 (orks 5, trolls 6)', portees:'[OK/–/–/–]' },
        { name:'Couteau de combat', vd:'5 (orks 6, trolls 7)', portees:'[OK/–/–/–]' },
        { name:'Pistolet lourd',    vd:'5',                    portees:'[OK/OK/Dés./–]' },
    ...
    'Johnson': {
      ...
      attrsMeta: { Ork:{ FOR:3 }, Troll:{ FOR:4 }, Nain:{ VOL:4 }, Elfe:{ VOL:4, CHA:4 } },
      skills: [
        { name:'Athlétisme',       val:3, attr:'FOR', rr:0 },
        { name:'Déf. à distance',  val:3, attr:'AGI', rr:0, spec:true },
        { name:'Armes à distance', val:3, attr:'AGI', rr:0, spec:'Pistolets', specVal:4, specRR:1 },
        { name:'Combat rapproché', val:3, attr:'AGI', rr:0 },
        { name:'Furtivité',        val:3, attr:'AGI', rr:0, spec:'Discrétion physique', specVal:4, specRR:0 },
        { name:'Perception',       val:3, attr:'LOG', rr:0 },
        { name:'Influence',        val:5, attr:'CHA', rr:1, spec:'Négociation/Bluff', specVal:5, specRR:1 },
    ...
    'Enquêteur': {
      ...
      skills: [
        ...
        { name:'Furtivité',        val:3, attr:'AGI', rr:0, spec:'Discrétion physique', specVal:4, specRR:0 },
        { name:'Perception',       val:4, attr:'LOG', rr:0, spec:'Physique', specVal:5, specRR:1 },
        { name:'Électronique',     val:3, attr:'LOG', rr:0, spec:'Recherche matricielle', specVal:5, specRR:1 },
        { name:'Influence',        val:4, attr:'CHA', rr:0, spec:'Intimidation', specVal:5, specRR:0 },
        { name:'Réseau',           val:4, attr:'CHA', rr:0, spec:'Gouvernemental', specVal:4, specRR:0 },
      ],
      atouts: [
  ...
  generate(opts) {
    ...
    let profKey = opts.profession === 'Aléatoire'
      ? Utils.rand(profList)
      : opts.profession;
    ...
    if (profil.atoutsChoix > 0 && profil.atoutsOptions.length > 0) {
      const shuffled = [...profil.atoutsOptions].sort(() => Math.random() - 0.5);
    ...
    // Rang selon profil
    const rangMap = {
      'Ganger': 'Figurant', 'Agent de sécurité': 'Figurant', 'Employé corporatiste': 'Figurant',
      'Ganger d\'élite': 'Figurant d\'élite', 'Officier de sécurité': 'Figurant d\'élite',
      'Mage de sécurité': 'Figurant d\'élite', 'Adepte de sécurité': 'Figurant d\'élite',
      'Decker de sécurité': 'Figurant d\'élite', 'Militaire': 'Figurant d\'élite',
      'Johnson': 'Lieutenant', 'Enquêteur': 'Lieutenant',
      'Officier d\'élite': 'Lieutenant', 'Mage d\'élite': 'Lieutenant',
      'Adepte d\'élite': 'Lieutenant', 'Decker d\'élite': 'Lieutenant',
      'Commando militaire': 'Boss',
    };
    const rang = opts.rang && opts.rang !== 'Aléatoire' ? opts.rang : (rangMap[profKey] || 'Figurant');
  ...
  recalc(pnj) {
    // Pas de dérivés complexes en Anarchy — les seuils sont fixes par profil
    return pnj;
  },
};