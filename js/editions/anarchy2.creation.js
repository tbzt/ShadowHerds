...
Object.assign(EditionAnarchy2, {
  creation: {
        ...
        byLevel: {
          ganger: {
            ...
            skills: [
              ...
              { name: "Athlétisme", val: 4 },
              { name: "Perception", val: 4 },
              { name: "Furtivité", val: 4 },
              { name: "Pilotage", val: 3 },
              { name: "Survie", val: 3 },
              { name: "Électronique", val: 3 },
            ],
            edges: [
              { level: 2, text: "Smartlink (cyberware) : RR 1 aux tests d'Armes à distance (pistolets)" },
              { level: 3, text: "Réflexes câblés (cyberware) : +1 action par combat" },
              { level: 2, text: "Armure dermique (cyberware) : Armure +1" },
              { level: 2, text: "Bras cybernétique (cyberware) : RR 1 aux tests de Combat rapproché" },
              { level: 2, text: "Substituts musculaires (cyberware) : VD +1 en combat rapproché" },
              { level: 2, text: "Camouflage thermo-optique (équipement) : RR 1 aux tests de Furtivité" },
              { level: 2, text: "Zélé (trait) : Avantage pour résister à l'intimidation ou la peur" },
              { level: 1, text: "Couteau à cran (équipement) : VD +1 en combat rapproché" },
              { level: 1, text: "Jazz (drogue) : +1 action par combat" },
            ],
          },
          runner: {
            ...
            edges: [
              { level: 2, text: "Smartlink (cyberware) : RR 1 aux tests d'Armes à distance (pistolets)" },
              { level: 3, text: "Réflexes câblés (cyberware) : +1 action par combat" },
              { level: 3, text: "Armure dermique (cyberware) : Armure +1" },
              { level: 2, text: "Bras cybernétique (cyberware) : RR 1 aux tests de Combat rapproché" },
              { level: 2, text: "Substituts musculaires (cyberware) : VD +1 en combat rapproché" },
              { level: 2, text: "Camouflage thermo-optique (équipement) : RR 1 aux tests de Furtivité" },
              { level: 2, text: "Réseau tactique avancé (amélioration de cyberware) : RR 1 aux tests d'Athlétisme (défense à distance)" },
              { level: 2, text: "Producteur de plaquettes (bioware) : +1 blessure légère" },
              { level: 2, text: "Zélé (trait) : Avantage pour résister à l'intimidation ou la peur" },
              { level: 1, text: "Couteau à cran (équipement) : VD +1 en combat rapproché" },
              { level: 1, text: "Jazz (drogue) : +1 action par combat" },
            ],
          ...
          elite: {
            ...
            skills: [
              ...
              { name: "Combat rapproché", val: 6 },
              { name: "Athlétisme", val: 5 },
              { name: "Perception", val: 5 },
              { name: "Furtivité", val: 5 },
              { name: "Pilotage", val: 4 },
              { name: "Survie", val: 4 },
              { name: "Électronique", val: 4 },
            ],
            edges: [
              { level: 2, text: "Yeux cybernétiques avec smartlink (cyberware) : RR 1 aux tests d'Armes à distance (pistolets), vision nocturne" },
              { level: 2, text: "Smartlink (cyberware) : RR 1 aux tests d'Armes à distance" },
              { level: 3, text: "Réflexes câblés (cyberware) : +1 action par combat" },
              { level: 3, text: "Armure dermique (cyberware) : Armure +1" },
              { level: 3, text: "Bras cybernétique (cyberware) : RR 1 aux tests de Combat rapproché" },
              { level: 2, text: "Substituts musculaires (cyberware) : VD +1 en combat rapproché" },
              { level: 2, text: "Camouflage thermo-optique (équipement) : RR 1 aux tests de Furtivité" },
              { level: 2, text: "Réseau tactique avancé (amélioration de cyberware) : RR 1 aux tests d'Athlétisme (défense à distance)" },
              { level: 2, text: "Producteur de plaquettes (bioware) : +1 blessure légère" },
              { level: 2, text: "Zélé (trait) : Avantage pour résister à l'intimidation ou la peur" },
              { level: 2, text: "Couteau à cran (équipement) : VD +1 en combat rapproché" },
              { level: 1, text: "Jazz (drogue) : +1 action par combat" },
            ],
          },
        },
      },
      {
        ...
        byLevel: {
          ganger: {
            ...
            edges: [
              { level: 3, text: "Focus de combat (équipement) : RR 1 aux tests de Sorcellerie (sorts de combat)" },
              { level: 2, text: "Focus de détection (équipement) : RR 1 aux tests de Sorcellerie (sorts de détection)" },
              { level: 2, text: "Focus de manipulation (équipement) : RR 1 aux tests de Sorcellerie (sorts de manipulation)" },
              { level: 2, text: "Focus des bêtes (équipement) : RR 1 aux tests de Conjuration (esprits des bêtes)" },
              { level: 2, text: "Camouflage thermo-optique (équipement) : RR 1 aux tests de Furtivité" },
              { level: 2, text: "Zélé (trait) : Avantage pour résister à l'intimidation ou la peur" },
              { level: 1, text: "Datajack (cyberware) : RR 1 aux tests Matriciels" },
            ],
          },
          runner: {
            ...
            edges: [
              ...
              { level: 2, text: "Focus de détection (équipement) : RR 1 aux tests de Sorcellerie (sorts de détection)" },
              { level: 2, text: "Focus de manipulation (équipement) : RR 1 aux tests de Sorcellerie (sorts de manipulation)" },
              { level: 2, text: "Focus de santé (équipement) : RR 1 aux tests de Sorcellerie (sorts de santé)" },
              { level: 2, text: "Focus des bêtes (équipement) : RR 1 aux tests de Conjuration (esprits des bêtes)" },
              { level: 2, text: "Camouflage thermo-optique (équipement) : RR 1 aux tests de Furtivité" },
              { level: 2, text: "Réseau d'informateurs (contacts) : RR 1 aux tests de Réseau" },
              { level: 2, text: "Zélé (trait) : Avantage pour résister à l'intimidation ou la peur" },
              { level: 1, text: "Datajack (cyberware) : RR 1 aux tests Matriciels" },
            ],
          },
          elite: {
            attrs: { FOR: 2, AGI: 3, VOL: 4, LOG: 4, CHA: 3 },
            skills: [
              { name: "Sorcellerie", val: 6, spec: "Sorts de combat" },
              { name: "Conjuration", val: 6 },
              { name: "Perception", val: 5 },
              { name: "Influence", val: 5 },
              { name: "Furtivité", val: 5 },
              { name: "Athlétisme", val: 4 },
              { name: "Électronique", val: 4 },
              { name: "Survie", val: 4 },
            ...
            edges: [
              { level: 4, text: "Focus de combat (équipement) : RR 2 aux tests de Sorcellerie (sorts de combat)" },
              { level: 3, text: "Focus de détection (équipement) : RR 2 aux tests de Sorcellerie (sorts de détection)" },
              { level: 3, text: "Focus des bêtes (équipement) : RR 2 aux tests de Conjuration (esprits des bêtes)" },
              { level: 3, text: "Focus des aînés (équipement) : RR 2 aux tests de Conjuration (esprits des aînés)" },
              { level: 2, text: "Focus de manipulation (équipement) : RR 1 aux tests de Sorcellerie (sorts de manipulation)" },
              { level: 2, text: "Focus de santé (équipement) : RR 1 aux tests de Sorcellerie (sorts de santé)" },
              { level: 2, text: "Camouflage thermo-optique (équipement) : RR 1 aux tests de Furtivité" },
              { level: 2, text: "Réseau d'informateurs (contacts) : RR 1 aux tests de Réseau" },
        ...
        byLevel: {
          ganger: {
            ...
            skills: [
              ...
              { name: "Électronique", val: 4 },
              { name: "Ingénierie", val: 4 },
              { name: "Perception", val: 4 },
              { name: "Réseau", val: 4 },
              { name: "Furtivité", val: 4 },
              { name: "Athlétisme", val: 3 },
              { name: "Influence", val: 2 },
            ],
            edges: [
              { level: 2, text: "Programme Agresseur (équipement) : RR 1 aux tests de Piratage (cybercombat)" },
              { level: 2, text: "Programme Exploitation (équipement) : RR 1 aux tests de Piratage (force brute)" },
              { level: 2, text: "Programme Navigateur (équipement) : RR 1 aux tests d'Électronique (recherche matricielle)" },
              { level: 2, text: "Datajack (cyberware) : RR 1 aux tests Matriciels" },
              { level: 2, text: "Camouflage thermo-optique (équipement) : RR 1 aux tests de Furtivité" },
              { level: 2, text: "Yeux cybernétiques (cyberware) : RR 1 aux tests de Perception (physique)" },
              { level: 2, text: "Atelier portatif (équipement) : RR 1 aux tests d'Ingénierie" },
              { level: 2, text: "Zélé (trait) : Avantage pour résister à l'intimidation ou la peur" },
              { level: 1, text: "Application navigateur (équipement) : RR 1 aux tests d'Électronique (recherche matricielle)" },
              { level: 1, text: "Réseau d'informateurs (contacts) : RR 1 aux tests de Réseau" },
            ],
          },
          runner: {
            ...
            edges: [
              ...
              { level: 2, text: "Programme Exploitation (équipement) : RR 1 aux tests de Piratage (force brute)" },
              { level: 2, text: "Programme Navigateur (équipement) : RR 1 aux tests d'Électronique (recherche matricielle)" },
              { level: 3, text: "Programme Marteau (équipement) : VD +2 en cybercombat" },
              { level: 3, text: "Programme Biofeedback (équipement) : inflige des dommages de biofeedback en cybercombat" },
              { level: 3, text: "Réflexes câblés (cyberware) : +1 action par combat" },
              { level: 2, text: "Datajack (cyberware) : RR 1 aux tests Matriciels" },
              { level: 2, text: "Camouflage thermo-optique (équipement) : RR 1 aux tests de Furtivité" },
              { level: 2, text: "Yeux cybernétiques (cyberware) : RR 1 aux tests de Perception (physique)" },
          ...
          elite: {
            attrs: { FOR: 2, AGI: 4, VOL: 3, LOG: 4, CHA: 3 },
            skills: [
              { name: "Piratage", val: 6, spec: "Cybercombat" },
              { name: "Électronique", val: 6 },
              { name: "Ingénierie", val: 5 },
              { name: "Perception", val: 5 },
              { name: "Réseau", val: 5 },
              { name: "Furtivité", val: 4 },
              { name: "Athlétisme", val: 4 },
            ...
            edges: [
              { level: 3, text: "Programme Agresseur (équipement) : RR 2 aux tests de Piratage (cybercombat)" },
              { level: 3, text: "Programme Exploitation (équipement) : RR 2 aux tests de Piratage (force brute)" },
              { level: 3, text: "Programme Navigateur (équipement) : RR 2 aux tests d'Électronique (recherche matricielle)" },
              { level: 3, text: "Programme Moniteur (équipement) : RR 2 aux tests d'Électronique (protection matricielle)" },
              { level: 3, text: "Programme Marteau (équipement) : VD +2 en cybercombat" },
              { level: 3, text: "Programme Biofeedback (équipement) : inflige des dommages de biofeedback en cybercombat" },
              { level: 3, text: "Réflexes câblés (cyberware) : +1 action par combat" },
              { level: 2, text: "Datajack (cyberware) : RR 1 aux tests Matriciels" },
              { level: 2, text: "Camouflage thermo-optique (équipement) : RR 1 aux tests de Furtivité" },
              { level: 2, text: "Yeux cybernétiques (cyberware) : RR 1 aux tests de Perception (physique)" },
              { level: 1, text: "Atelier portatif (équipement) : RR 1 aux tests d'Ingénierie" },
            ],
          },
        },
      },
      {
        ...
        byLevel: {
          ganger: {
            ...
            edges: [
              { level: 2, text: "Base de données commerciale (équipement) : RR 1 aux tests d'Influence (négociation)" },
              { level: 2, text: "Réseau d'informateurs (contacts) : RR 1 aux tests de Réseau" },
              { level: 2, text: "Passe ses journées sur les réseaux (trait) : RR 1 aux tests de Réseau (corporatiste)" },
              { level: 3, text: "Garde du corps (allié) : soutien en combat rapproché" },
              { level: 2, text: "Voiture sportive (véhicule) : Autopilote 6, Structure 5, Maniabilité 2, Vitesse 5, Blindage 0" },
              { level: 2, text: "Datajack (cyberware) : RR 1 aux tests Matriciels" },
              { level: 2, text: "Camouflage thermo-optique (équipement) : RR 1 aux tests de Furtivité" },
              { level: 2, text: "Zélé (trait) : Avantage pour résister à l'intimidation ou la peur" },
              { level: 1, text: "Application navigateur (équipement) : RR 1 aux tests d'Électronique (recherche matricielle)" },
          ...
          runner: {
            attrs: { FOR: 2, AGI: 3, VOL: 3, LOG: 2, CHA: 4 },
            skills: [
            ...
            edges: [
              { level: 2, text: "Base de données commerciale (équipement) : RR 1 aux tests d'Influence (négociation)" },
              { level: 3, text: "Réseau d'informateurs (contacts) : RR 1 aux tests de Réseau" },
              { level: 2, text: "Passe ses journées sur les réseaux (trait) : RR 1 aux tests de Réseau (corporatiste)" },
              { level: 3, text: "Garde du corps (allié) : soutien en combat rapproché" },
              { level: 3, text: "Voiture de sport tunée (véhicule) : Autopilote 6, Structure 5, Maniabilité 2, Vitesse 6, Blindage 3 ; RR 1 aux tests de Pilotage (voitures)" },
              { level: 2, text: "Smartlink (cyberware) : RR 1 aux tests d'Armes à distance (pistolets)" },
              { level: 2, text: "Datajack (cyberware) : RR 1 aux tests Matriciels" },
              { level: 2, text: "Camouflage thermo-optique (équipement) : RR 1 aux tests de Furtivité" },
              { level: 2, text: "Jazz (drogue) : +1 action par combat" },
              { level: 2, text: "Zélé (trait) : Avantage pour résister à l'intimidation ou la peur" },
              { level: 1, text: "Application navigateur (équipement) : RR 1 aux tests d'Électronique (recherche matricielle)" },
            ],
          },
          elite: {
            attrs: { FOR: 2, AGI: 3, VOL: 4, LOG: 3, CHA: 4 },
            skills: [
              { name: "Influence", val: 6, spec: "Négociation" },
              { name: "Réseau", val: 6 },
              { name: "Perception", val: 5 },
              { name: "Armes à distance", val: 5 },
              { name: "Furtivité", val: 5 },
              { name: "Athlétisme", val: 4 },
              { name: "Électronique", val: 4 },
              { name: "Pilotage", val: 4 },
            ...
            edges: [
              { level: 3, text: "Base de données commerciale (équipement) : RR 1 aux tests d'Influence (négociation)" },
              { level: 3, text: "Réseau d'informateurs (contacts) : RR 1 aux tests de Réseau" },
              { level: 3, text: "Passe ses journées sur les réseaux (trait) : RR 1 aux tests de Réseau (corporatiste)" },
              { level: 3, text: "Garde du corps (allié) : soutien en combat rapproché" },
              { level: 3, text: "Voiture de sport tunée (véhicule) : Autopilote 6, Structure 5, Maniabilité 2, Vitesse 6, Blindage 3 ; RR 1 aux tests de Pilotage (voitures)" },
              { level: 3, text: "Yeux cybernétiques (cyberware) : RR 1 aux tests de Perception (physique)" },
              { level: 2, text: "Smartlink (cyberware) : RR 1 aux tests d'Armes à distance (pistolets)" },
              { level: 2, text: "Datajack (cyberware) : RR 1 aux tests Matriciels" },
              { level: 2, text: "Camouflage thermo-optique (équipement) : RR 1 aux tests de Furtivité" },
              { level: 2, text: "Jazz (drogue) : +1 action par combat" },
        ...
        byLevel: {
          ganger: {
            ...
            skills: [
              ...
              { name: "Armes à distance", val: 4 },
              { name: "Athlétisme", val: 3 },
              { name: "Furtivité", val: 3 },
              { name: "Réseau", val: 2 },
            ],
            edges: [
              { level: 4, text: "2 MCT-Nissan Roto-drone (drones volants moyens) : Autopilote 6, Structure 2, Maniabilité 7, Vitesse 6, Blindage 2, avec fusil d'assaut" },
              { level: 2, text: "Moto personnalisée (véhicule) : RR 1 aux tests de Pilotage (motos)" },
              { level: 2, text: "Drone utilitaire (équipement) : assistance aux réparations" },
              { level: 2, text: "Atelier portatif (équipement) : RR 1 aux tests d'Ingénierie" },
              { level: 2, text: "Base de données techniques en RA (équipement) : RR 1 aux tests d'Ingénierie (C&R au choix)" },
              { level: 2, text: "Datajack (cyberware) : RR 1 aux tests Matriciels" },
              { level: 2, text: "Camouflage thermo-optique (équipement) : RR 1 aux tests de Furtivité" },
              { level: 2, text: "Zélé (trait) : Avantage pour résister à l'intimidation ou la peur" },
            ],
          ...
          runner: {
            ...
            edges: [
              { level: 4, text: "2 MCT-Nissan Roto-drone (drones volants moyens) : Autopilote 6, Structure 2, Maniabilité 7, Vitesse 6, Blindage 2, avec fusil d'assaut" },
              { level: 4, text: "2 GM-Nissan Doberman (drones moyens) : Autopilote 6, Structure 2, Maniabilité 7, Vitesse 3, Blindage 2, avec fusil d'assaut" },
              { level: 3, text: "Fourgon (véhicule) : Autopilote 6, Structure 8, Maniabilité 1, Vitesse 3, Blindage 4" },
              { level: 2, text: "Moto personnalisée (véhicule) : RR 1 aux tests de Pilotage (motos)" },
              { level: 2, text: "Drone utilitaire (équipement) : assistance aux réparations" },
              { level: 2, text: "Atelier portatif (équipement) : RR 1 aux tests d'Ingénierie" },
              { level: 2, text: "Base de données techniques en RA (équipement) : RR 1 aux tests d'Ingénierie (C&R au choix)" },
              { level: 2, text: "Datajack (cyberware) : RR 1 aux tests Matriciels" },
              { level: 2, text: "Camouflage thermo-optique (équipement) : RR 1 aux tests de Furtivité" },
              { level: 1, text: "Zélé (trait) : Avantage pour résister à l'intimidation ou la peur" },
            ],
          },
          elite: {
            attrs: { FOR: 2, AGI: 4, VOL: 3, LOG: 4, CHA: 3 },
            skills: [
              ...
              { name: "Ingénierie", val: 6, spec: "C&R drones" },
              { name: "Électronique", val: 5 },
              { name: "Perception", val: 5 },
              { name: "Armes à distance", val: 5 },
              { name: "Athlétisme", val: 4 },
            ...
            edges: [
              { level: 5, text: "T-bird Ares Venture (véhicule) : Autopilote 6, Vitesse 10, Blindage 4 ; RR 1 aux tests de Pilotage (véhicules volants), avec mitrailleuse en tourelle" },
              { level: 4, text: "2 MCT-Nissan Roto-drone (drones volants moyens) : Autopilote 6, Structure 2, Maniabilité 7, Vitesse 6, Blindage 2, avec fusil d'assaut" },
              { level: 4, text: "2 GM-Nissan Doberman (drones moyens) : Autopilote 6, Structure 2, Maniabilité 7, Vitesse 3, Blindage 2, avec fusil d'assaut" },
              { level: 3, text: "Médikit autonome DocWagon Pro+ (drone) Autopilote 9, fixe" },
              { level: 2, text: "Moto personnalisée (véhicule) : RR 1 aux tests de Pilotage (motos)" },
              { level: 2, text: "Drone utilitaire (équipement) : assistance aux réparations" },
              { level: 2, text: "Atelier portatif (équipement) : RR 1 aux tests d'Ingénierie" },
              { level: 2, text: "Base de données techniques en RA (équipement) : RR 1 aux tests d'Ingénierie (C&R au choix)" },
    ...
    stepErrors(build) {
      ...
      /* Budget mode table : les points de chaque catégorie sont une
         ALLOCATION À RÉPARTIR, pas un plafond — « Les tables de création de
         personnages proposent une répartition précalculée des nuyens de
         départ [...] Le total correspond à la valeur à répartir pour un
         niveau de jeu donné » (p.86). Tout se paie en nuyens : une catégorie
         sous-dépensée, ce sont des nuyens PERDUS, et le personnage sort à
         moitié construit sans que rien ne le dise. C'est ainsi que les cinq
         presets de démarrage rapide ont vécu avec zéro Atout sur 14 à 28.

         ⚠ La règle s'inverse en mode avancé, où le livre autorise à
         « transférer des nuyens d'une catégorie à l'autre » : là, seule la
         jauge globale fait foi et une catégorie creuse est un choix légitime.
         Ne pas étendre ces contrôles au mode avancé. */
      if (!build.advancedMode && table) {
        ...
        if (attrPts < table.attrPoints) out.attrs.push(`Tous les points d'attribut doivent être répartis (${attrPts}/${table.attrPoints}) — le reliquat est du nuyen perdu.`);
        ...
        if (skillPts < table.skillPoints) out.skills.push(`Tous les points de compétence doivent être répartis (${skillPts}/${table.skillPoints}) — le reliquat est du nuyen perdu.`);
        ...
        if (edgePts < table.edgePoints) out.edges.push(`Tous les points d'Atout doivent être répartis (${edgePts}/${table.edgePoints}) — le reliquat est du nuyen perdu.`);
      }
