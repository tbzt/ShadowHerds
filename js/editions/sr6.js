...
const EditionSR6 = {
  ...
  formOptions: {
    ...
    special:    ['Aucun','Aléatoire','Lieutenant','Decker','Adepte','Magicien','Chaman'],
  },
  ...
  specialSkills: {
    'Lieutenant':  [],
    'Decker':      [{ name: 'Informatique', bonus: 4 }, { name: 'Cracking', bonus: 3 }, { name: 'Cybercombat', bonus: 2 }],
    'Adepte':      [{ name: 'Athlétisme (voie)', bonus: 3 }, { name: 'Combat (voie)', bonus: 2 }],
    'Magicien':    [{ name: 'Magie', bonus: 4 }, { name: 'Lancer de sorts', bonus: 3 }, { name: 'Invocation', bonus: 2 }],
    'Chaman':      [{ name: 'Magie', bonus: 3 }, { name: 'Invocation', bonus: 4 }, { name: 'Lancer de sorts', bonus: 2 }],
  },

  spellsBySpecial: {
    'Magicien': ['Boule de feu','Éclair','Armure de mana','Paralysie','Détection'],
    'Chaman':   ['Guérison','Sommeil','Confusion','Convocation','Barrière d\'air'],
  },

  adeptPowers: [
    'Mains de soie','Réflexes de combat','Frappe de mana','Résistance à la douleur','Sprint','Perception accrue','Réflexes améliorés'
  ],

  equipByProfession: {
    'Civil': [
      ['Pistolet léger Fichetti'],
      ['Pistolet','Commlink Renraku'],
    ],
    'Voyou': [
      ['Pistolet','Couteau'],
    ...
    'Forces d\'intervention': [
      ...
      ['Fusil d\'assaut','Arme lourde','Armure militaire','Grenades','Véhicule blindé'],
    ],
    'Forces spéciales': [
      ['Fusil d\'assaut','Sniper','Armure militaire','Explosifs'],
      ['Fusil d\'assaut','Sniper','Armure militaire','Explosifs','Drones','Grenades flash'],
    ],
  },
  ...
  augsBySpecial: {
    ...
    'Chaman':     ()     => [],
    'Aucun':      (prof) => prof >= 4
      ? [Utils.rand(['Réflexes câblés 1','Œil cybernétique (smart)','Oreille cybernétique','Commlink intégré'])]
      : [],
  },
