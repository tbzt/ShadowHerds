...
const App = {
  ...
  _EDITION_JS: {
    sr5: ["js/editions/sr5.js?v=961", "js/editions/sr5.foundry.js?v=4", "js/editions/sr5.print.js?v=1"],
    sr6: ["js/editions/sr6.js?v=961", "js/editions/sr6.foundry.js?v=5", "js/editions/sr6.print.js?v=1"],
    anarchy2: [
      "js/editions/anarchy2.js?v=45",
      "js/editions/anarchy2.creation.js?v=6",
      "js/editions/anarchy2.foundry.js?v=6",
      "js/editions/anarchy2.print.js?v=3",
    ],
    anarchy1: ["js/editions/anarchy1.js?v=20", "js/editions/anarchy1.print.js?v=1"],
  },
