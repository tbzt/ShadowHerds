...
const App = {
  ...
  _EDITION_JS: {
    ...
    sr6: ["js/editions/sr6.js?v=960", "js/editions/sr6.foundry.js?v=5", "js/editions/sr6.print.js?v=1"],
    anarchy2: [
      "js/editions/anarchy2.js?v=44",
      "js/editions/anarchy2.creation.js?v=6",
      "js/editions/anarchy2.foundry.js?v=6",
      "js/editions/anarchy2.print.js?v=3",
    ],
    anarchy1: ["js/editions/anarchy1.js?v=19", "js/editions/anarchy1.print.js?v=1"],
  },
