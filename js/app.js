...
const App = {
  ...
  _EDITION_CSS: {
    sr5: "css/theme-sr5.css?v=1097",
    sr6: "css/theme-sr6.css?v=1097",
    anarchy2: "css/theme-anarchy.css?v=1097",
  ...
  _EDITION_JS: {
    ...
    anarchy1: ["js/editions/anarchy1.js?v=1097", "js/editions/anarchy1.print.js?v=1097"],
  },
  // Commun à toutes les éditions (catalogue de créatures, lu dès buildForms).
  _COMMON_JS: ["js/catalogs/creatures.js?v=1097"],
  _loadCss(href) {
