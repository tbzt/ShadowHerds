...
const App = {
  ...
  _EDITION_CSS: {
    sr5: "css/theme-sr5.css?v=1055",
    sr6: "css/theme-sr6.css?v=1055",
    anarchy2: "css/theme-anarchy.css?v=1055",
    anarchy1: "css/theme-anarchy1.css?v=1055",
  },
  _EDITION_JS: {
    sr5: ["js/editions/sr5.js?v=1055", "js/editions/sr5.foundry.js?v=1055", "js/editions/sr5.print.js?v=1055"],
    sr6: ["js/editions/sr6.js?v=1055", "js/editions/sr6.foundry.js?v=1055", "js/editions/sr6.print.js?v=1055"],
    anarchy2: [
      "js/editions/anarchy2.js?v=1055",
      "js/editions/anarchy2.creation.js?v=1055",
      "js/editions/anarchy2.foundry.js?v=1055",
      "js/editions/anarchy2.print.js?v=1055",
    ],
    anarchy1: ["js/editions/anarchy1.js?v=1055", "js/editions/anarchy1.print.js?v=1055"],
  },
  // Commun à toutes les éditions (catalogue de créatures, lu dès buildForms).
  _COMMON_JS: ["js/catalogs/creatures.js?v=1055"],
  _loadCss(href) {
