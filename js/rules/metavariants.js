...
const Metavariants = {
  ...
  zoocanthropes: {
    ...
    Léonin: {
      ...
      traits: [
        "Armes naturelles (Crocs, Griffes)",
        "Déplacement (×2/×6/+4)",
        "Illettré",
        "Sens de l'équilibre",
        "Spectre auditif élargi (Ultrasons)",
  ...
  sr6: {
    metavariants: {
      ...
      Cyclope: {
        ...
        traits: [
          "Œil cyclopéen",
          { name: "Robuste 2", bonus: { monitor: 2 } },
          "Vision thermographique",
        ],
        originPools: ["euro", "arabe"],
      },
