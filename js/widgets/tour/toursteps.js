...
export const TourSteps = {
  steps: [
    ...
    {
      id: "wn-champs-par-defaut", anchor: "nav-settings", tours: ["whatsnew"], since: "1.155.0", fallback: "center",
      title: "Les champs de saisie ont enfin une apparence",
      body: "L'application n'avait aucune règle de base sur les zones de texte, les listes déroulantes et les champs de formulaire : chacun dépendait de sa classe, et celui qui n'en avait pas gardait les couleurs du navigateur — fond blanc, texte noir, bordure système, vingt pixels de haut — au milieu d'une interface sombre. Le champ de recherche d'Ombres portées et de Personnages, les champs de l'assistant de création, ceux de l'inspecteur de scène des Trames et une liste des Paramètres étaient dans ce cas. Ce n'était pas quatre défauts, c'était un socle manquant : il existe maintenant, tous les champs s'y conforment et passent à trente-deux pixels de haut. Les cases à cocher, boutons radio, curseurs et sélecteurs de fichier gardent leur rendu natif — les habiller comme une zone de texte les casserait.",
    },
    {
      id: "wn-suppl-matrice", anchor: "nav-combat", tours: ["whatsnew"], since: "1.154.0", fallback: "center",
      title: "Les suppléments Matrice entrent au catalogue",
      body: "Le catalogue s'arrêtait au livre de base. « Hacker vaillant » apporte vingt-deux actions à Shadowrun 6 — Analyse des menaces, Attaque par interception, Calibrage, Commande retardée, Déni de service, Détournement d'infrastructure, Mascarade, Sentinelle, Verrouillage d'appareil et les autres —, chacune avec son test, son test de défense, son niveau d'accès et son effet. « Data Trails » ajoute les deux seules que le supplément Matrice de Shadowrun 5 contient : Inversion des entrées/sorties et Remonter un rétrolien. Ses quatre programmes, eux, étaient déjà là. Shadowrun 6 passe ainsi de 33 à 55 actions matricielles, Shadowrun 5 de 33 à 35.",
    },
    {
      id: "wn-actions-optionnelles", anchor: "nav-combat", tours: ["whatsnew"], since: "1.154.0", fallback: "center",
      title: "Ce qui est optionnel se voit, et dit d'où il vient",
      body: "Sept des actions de « Hacker vaillant » sont rangées par le livre sous « La Matrice, comme au cinéma ! », et il les présente lui-même comme optionnelles : Affiner, Attaque de la Tête de mort, Déchiqueteur de CI, J'suis entré !, Séquenceur de mot de passe, Virtuose du clavier et Virus informatique. Elles s'affichent ternies, en pointillés, avec la mention « opt. » — montrées, jamais retirées, parce que c'est à vous d'en décider. Et maintenant que le bordereau du Score de Surveillance mêle le livre de base et les suppléments, son infobulle nomme la source de chaque action. Trois bonus d'Atout matriciels arrivent aussi — Intervention, Marquage de cible, Traitement par lot — mais dans le catalogue des actions d'Atout, pas dans celui des actions : ils se paient en Atout et se greffent sur un jet sans consommer d'action.",
    },
    {
      id: "wn-intrusion-console", anchor: "nav-combat", tours: ["whatsnew"], since: "1.153.0", fallback: "center",
      title: "L'intrusion s'invite dans la console d'action",
      body: "Pendant qu'un decker travaille, ce que vous deviez avoir sous les yeux — dans quel serveur il est, l'accès qu'il tient, son Score de Surveillance et ce qui le sépare de la convergence — vivait dans l'autre colonne : deux endroits à regarder pour un seul tour. La console porte maintenant une rangée Matrice, jumelle de celle de la course-poursuite. L'accès s'y dit dans l'échelle de votre livre : des marks en Shadowrun 5, un niveau nommé en Shadowrun 6, jamais le mot de l'autre édition. Et le Score de Surveillance change de teinte en approchant du seuil — trois crans, pas un dégradé : vous lisez un état, pas une température.",
    },
    {
      id: "wn-bordereau-ss", anchor: "nav-combat", tours: ["whatsnew"], since: "1.153.0", fallback: "center",
      title: "Le bordereau du Score de Surveillance",
      body: "Les actions que le livre déclare illégales sont maintenant listées au tour de l'intéressé — 14 en Shadowrun 5, 16 en Shadowrun 6, relevées aux livres. Quand votre joueur annonce « je fais un Pic de données », un tap vous demande les succès obtenus par la cible à son test de défense, et l'inscrit au journal sous le nom de l'action. C'est exactement ce que dit la règle : « son SS augmente du nombre de succès que la cible obtient à son test de défense ». L'application ne calcule rien et ne devine rien — le seul personnage qui accumule du Score de Surveillance est le decker joueur, qui ne touche pas l'application. Elle vous évite juste de le tenir de tête. Une contre-mesure, elle, ne se voit rien proposer : le livre l'en exempte explicitement (« les G-men, spiders de sécurité, CI […] n'accumulent jamais de Score de Surveillance »), et l'écran le dit au lieu de masquer en silence.",
    },
    {
      id: "wn-jets-ci-au-tour", anchor: "nav-combat", tours: ["whatsnew"], since: "1.153.0", fallback: "center",
      title: "Les jets d'une CI se font à son tour",
      body: "Une contre-mesure entrée dans l'ordre d'initiative a sa propre fiche de console, qui porte déjà ses jets d'attaque, de défense et d'encaissement. Les garder en même temps sur le panneau du serveur en faisait deux endroits pour le même geste : ils n'y sont plus. Une CI en veille, qui n'a pas de tour et donc pas de console, garde les siens — lui retirer le seul endroit d'où la jouer aurait été un mauvais échange. C'est la même doctrine que la piste de poursuite : le panneau montre l'état, on agit au tour de l'intéressé.",
    },
    {
      id: "wn-de-poursuite-lance", anchor: "nav-combat", tours: ["whatsnew"], since: "1.152.0", fallback: "center",
      title: "Le ⚄ de la poursuite lance vraiment",
      body: "Sur une piste Shadowrun 5, deux PNJ sur trois n'avaient rien à lancer : sans compétence de conduite sur leur fiche, la pastille se contentait de poser un ✓ au jugé. Le livre avait pourtant la réponse, et il nomme justement notre cas — « Se défausser » (p. 132) permet de tenter le test avec le seul attribut et −1 dé, et cite « Véhicules terrestres » comme compétence qu'on peut tenter sans entraînement. Un PNJ sans la compétence lance donc RÉA − 1, et le libellé le dit. Shadowrun 6 et les deux Anarchy ne règlent pas la défausse : là, l'application vous demande la réserve une fois, puis la retient pour toute la poursuite — un tap par round ensuite. Un personnage joueur, lui, garde son ✓/✗ : il annonce, on ne lance pas à sa place. Au passage, un défaut plus vicieux a sauté : le filtre de compétence attrapait « Armes de véhicule », qui sert à tirer depuis un engin, pas à le conduire — un PNJ lançait 7 dés au lieu de 3, avec un chiffre trop plausible pour qu'on le remarque.",
    },
    {
      id: "wn-poursuite-a-pied", anchor: "nav-combat", tours: ["whatsnew"], since: "1.152.0", fallback: "center",
      title: "La poursuite à pied, enfin jouable",
      body: "Shadowrun 6 la réglait déjà — Athlétisme + Agilité, action majeure Sprinter, seuil selon l'environnement, et 4E encaissés si vous ratez en terrain encombré. Les trois autres éditions traînaient des scories de véhicule : un coureur se voyait proposer Percuter et Cascade, que le livre réserve aux pilotes, et la barre lui annonçait « véhicule hors de contrôle » quand il ratait. Shadowrun 5 propose maintenant Sprinter, une action qui existait au catalogue et n'apparaissait nulle part. Et courir se teste désormais en FORCE dans les deux Anarchy : la première range Athlétisme sous Force, la seconde l'écrit dans sa table (« Athlétisme : course (+F) ») — les deux modules l'appariaient à l'Agilité, en contredisant le catalogue de compétences de l'application. Le pilotage, lui, reste en Agilité.",
    },
    {
      id: "wn-actions-vers-la-console", anchor: "nav-combat", tours: ["whatsnew"], since: "1.152.0", fallback: "center",
      title: "La piste est un plateau, la console est la main",
      body: "Les manœuvres du livre, les quatorze actions d'Atout de course-poursuite et l'embarquement vivaient dans la fiche d'un participant, sur la piste — et depuis la version précédente, en double avec la console. Ils se jouent maintenant au tour de l'intéressé, là où se décide ce qui coûte une action : sa bande, son test, son déplacement acquis, ses manœuvres en portée, ses actions d'Atout, et « Monter dans… ». La piste garde ce qui n'a pas de tour — ancrer la cible, saisir une valeur que l'application ne tient pas, déclarer un Semé ou un Accident, compter une réserve. Une phrase fantôme disparaît au passage : « Aucune action de poursuite ouverte à ce participant » s'affichait dans trois éditions sur quatre, qui n'ont tout simplement pas de catalogue d'actions d'Atout de poursuite — elle ne pouvait jamais devenir vraie.",
    },
    {
