...
export const EncounterRenderer = {
  ...
  _activeTop(r, state) {
    ...
    // (le PJ decker l'attaque à SON tour) → le bloc « Appareils » vit dans la console
  ...
  /** V7 Lot 4 — appareils matriciels CIBLABLES dans la console Réagir : au tour
      ...
      deviennent des cibles de brickage (le PNJ les SUBIT). Un bloc « Appareils » unique,
  ...
  _renderReactionConsole(box, rows, active, modeEnter, state) {
    ...
    const rowsHtml = targets
      ...
      .join("");
    // V7 Lot 4 — bloc « Appareils » brickables brickables (le decker attaque le matos
